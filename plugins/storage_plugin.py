    ...
    def _load_data(self) -> Dict:
        ...
        if os.path.exists(self.storage_file):
            try:
                ...
                logger.error(f"Не удалось разобрать {self.storage_file}, создаются новые данные")
...
class StoragePlugin:
    ...
    def on_plugin_load(self):
        ...
        logger.info(f"Плагин хранения данных загружен, файл данных: {storage.storage_file}")
