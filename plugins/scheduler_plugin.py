"""
Scheduler Plugin for Telegram Bot (aiogram 3.x)

Этот плагин предоставляет функционал планирования (schedule) опросов и других задач.
Он обрабатывает планирование, напоминания и выполнение запланированных задач.
"""
